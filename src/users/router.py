...
from src.users.schemas import CuratorProfileUpdate, ExpertProfileUpdate, StudentProfileUpdate, UserFullResponse, UserPatchSchema, UserRolesEnum, UserSchemaFull, UserWithCuratorRequest, UserWithExpertRequest, UserWithStudentRequest, UserWithoutRoleResponse
...
async def update_student_profile(
    ...
    return UserWithStudentRequest(
        id=uuid4(),  # Или current_user["id"]
        email="student@example.com",
        first_name="Иван",
        middle_name="Иванович",
        last_name="Студентов",
        role=role, # Используем Enum, если он определен так
